    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_TASK:
                ...
                return new TaskViewHolder(view, title, date, circleImageView);
            default:
                return null;
        }
...
//            taskViewHolder.priority.setImageResource(R.drawable.circle);
            ...
            taskViewHolder.priority.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    getTaskFragment().activity.dbHelper.update().status(modelTask.getTime_stump(), ModelTask.STATUS_DONE);
                    ...
                    anim.addListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            if (modelTask.getStatus() == ModelTask.STATUS_DONE){
                                ...
                                translationSet.play(translationXBack).before(translationX);
